      ...
      <div class="tw:flex tw:flex-col tw:gap-4">
        ...
        <FormSection title="Program Details">
          ...
          <div class="tw:grid tw:grid-cols-1 tw:sm:grid-cols-2 tw:gap-3">
            ...
            <div v-if="program.programTypeId === 'SUPPLIER'" class="tw:flex tw:flex-col tw:gap-1">
              ...
              <SupplierSelectMenu v-if="isEditable" v-model="program.supplierId" :required="true" />
              <SupplierBadgeById v-else-if="program.supplierId" :supplierId="program.supplierId" />
              <span v-else class="tw:text-sm tw:text-secondary">—</span>
            </div>
          </div>
        </FormSection>
        ...
        <FormSection title="Schedule" :icon="IconCalendarTime">
          <div class="tw:grid tw:grid-cols-1 tw:sm:grid-cols-2 tw:gap-3">
            ...
            <div v-if="program.frequencyId === 'EVERY_X_DAYS'" class="tw:flex tw:flex-col tw:gap-1">
              <div class="tw:text-xs tw:text-secondary">
          ...
          >
            The daily generator mints an Audit when nextDueDate ≤ today. Pausing a program stops new
            audits; existing audits keep running.
          </div>
        </FormSection>

        <!-- Auditor pool card -->
        <FormSection title="Auditor Pool" :icon="IconUsers">
          <template #actions>
            <span class="tw:font-normal tw:normal-case tw:text-secondary tw:text-xs">
              {{ auditors.length }}
            </span>
            <BaseButton
              v-if="isEditable"
