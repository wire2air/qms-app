        ...
        <div class="tw:absolute tw:inset-0">
          <div v-for="(col, i) in layout.cols" :key="i" class="tw:contents">
            ...
            >
              ...
              >
                <span class="tw:flex-1 tw:truncate tw:font-medium tw:text-[11px]">{{
                  cause.text
                }}</span>
          ...
          >
            <div
              class="tw:text-xs tw:font-bold tw:uppercase tw:tracking-wider tw:text-red-500 tw:mb-1 tw:shrink-0"
            >
              Problem
            </div>
            <textarea
