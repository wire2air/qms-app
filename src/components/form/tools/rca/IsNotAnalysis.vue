    ...
    <div class="tw:overflow-x-auto">
      <table class="tw:w-full tw:text-sm">
        <thead>
          <tr>
            <th
              class="tw:text-left tw:text-xs tw:font-semibold tw:text-secondary tw:uppercase tw:pb-2 tw:w-28"
            >
              Dimension
            </th>
            <th
              class="tw:text-left tw:text-xs tw:font-semibold tw:text-secondary tw:uppercase tw:pb-2 tw:px-2 tw:text-green-700"
            >
              IS
            </th>
            <th
              class="tw:text-left tw:text-xs tw:font-semibold tw:text-secondary tw:uppercase tw:pb-2 tw:px-2 tw:text-red-600"
            >
              IS NOT
            </th>
          </tr>
