      ...
      >
        ...
        <div class="tw:grid tw:grid-cols-2 tw:sm:grid-cols-3 tw:lg:grid-cols-5 tw:gap-3 tw:mt-4">
          <div class="tw:bg-gray-50 tw:rounded-lg tw:px-3 tw:py-2">
            <p class="tw:text-caption tw:uppercase tw:tracking-wider tw:font-semibold tw:text-secondary">Total</p>
          ...
          <div class="tw:bg-gray-50 tw:rounded-lg tw:px-3 tw:py-2">
            <p class="tw:text-caption tw:uppercase tw:tracking-wider tw:font-semibold tw:text-secondary">Pending</p>
            <p class="tw:text-lg tw:font-bold tw:text-amber-600">
              {{ stats.completed + stats.inProgress }}
            </p>
          </div>
          <div class="tw:bg-gray-50 tw:rounded-lg tw:px-3 tw:py-2">
            <p class="tw:text-caption tw:uppercase tw:tracking-wider tw:font-semibold tw:text-secondary">Failed</p>
            <p
          ...
          <div class="tw:bg-gray-50 tw:rounded-lg tw:px-3 tw:py-2">
            <p class="tw:text-caption tw:uppercase tw:tracking-wider tw:font-semibold tw:text-secondary">Retrain</p>
            <p
              class="tw:text-lg tw:font-bold"
    ...
    <div v-if="libraryInstances.length" class="tw:flex tw:flex-col tw:gap-3">
      ...
      >
        ...
        <div class="tw:grid tw:grid-cols-2 tw:sm:grid-cols-4 tw:gap-3">
          ...
          <div class="tw:bg-gray-50 tw:rounded-lg tw:px-3 tw:py-2">
            <p class="tw:text-caption tw:uppercase tw:tracking-wider tw:font-semibold tw:text-secondary">Completed</p>
            <p class="tw:text-lg tw:font-bold tw:text-amber-600">
