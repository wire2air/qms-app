<script setup>
// Self-service account security — password, MFA, sessions, devices, history.
// Extracted from pages/security.vue so it can be rendered both as the /security
// page and as a tab on the profile page. Status/disable/regenerate are action
// RPCs (verb / secret-return endpoints), so they use the axios wrapper directly.
...
defineOptions({ name: 'PersonalSecurity' })
