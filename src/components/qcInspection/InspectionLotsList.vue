...
const columns = [
  ...
  { name: 'product', label: 'PRODUCT', field: (row) => productName(row.productId), align: 'left' },
  ...
  { name: 'disposition', label: 'DISPOSITION', field: (row) => dispositionName(row.dispositionTypeId), align: 'left' },
  { name: 'nc', label: 'NC', field: (row) => ncNumber(row.ncId), align: 'left' },
  {
    name: 'createdAt',
    label: 'CREATED',
    field: 'createdAt',
