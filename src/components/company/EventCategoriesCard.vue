...
<template>
  ...
  >
    ...
    >
      <template #subtitle>
        One classification shared by Quality Events, Nonconformances and CAPAs — it carries down the
        escalation chain, so a category picked on an event stays with the NC and CAPA it becomes.
