...
// weight column. Per-row Edit/Deactivate come from rowActions (gated — null
// hides the actions column entirely when the user lacks configure permission).
const columns = [
  ...
  >
    ...
    <div class="tw:p-4">
      <DataTable
        ...
        noDataLabel="No active severities. Add one above."
      >
