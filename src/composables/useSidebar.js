 ...
 *
 * Desktop (lg+): the sidebar sits inline in the layout and its open/closed
 * state is the persisted `sidebar-drawer` preference.
 *
 * iPad / phone (< lg): the sidebar is collapsed by default and opens as an
