...
export class QualityEvent extends BaseModel {
  ...
  @Property({ type: DateTime }) reviewDate = /** @type {DateTime} */ (null)
  @Property({ type: DateTime }) decisionDate = /** @type {DateTime} */ (null)
  @Property({ type: String }) reviewSummary = ''
  @Property({ type: Boolean }) rootCauseRequired = /** @type {Boolean} */ (null)
  @Property({ type: Boolean }) escalationRequired = /** @type {Boolean} */ (null)
