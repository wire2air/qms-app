...
// Per-tenant "Complaint Source" lookup (who reported). See
// docs/plans/complaint-qms-expansion.md (in the qms backend repo).
@ClientModel('complaintSourceTypes', {
  primaryKey: 'id',
  syncField: 'updatedAt',
  customIndex: 'companyId, [companyId+code]',
})
export class ComplaintSourceType extends BaseModel {
