...
// Per-tenant regulatory reporting scheme lookup for the reportability assessment
// (FDA MDR / EU MDR / MoCRA / Other).
@ClientModel('complaintReportSchemes', {
  primaryKey: 'id',
  syncField: 'updatedAt',
  customIndex: 'companyId, [companyId+code]',
})
export class ComplaintReportScheme extends BaseModel {
