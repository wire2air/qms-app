...
// Per-tenant Shift lookup (Day / Evening / Night …) with optional start/end
// times. Backs the QC in-process shift selection + inspector check-in.
@ClientModel('shifts', {
  primaryKey: 'id',
  syncField: 'updatedAt',
...
export class Shift extends BaseModel {
  ...
  @Property({ type: String }) startTime = /** @type {String} */ (null)
  @Property({ type: String }) endTime = /** @type {String} */ (null)
