      ...
      >
        ...
        >
          ...
          <span
            ...
            class="tw:inline-flex tw:items-center tw:justify-center tw:rounded-full tw:bg-main-hover tw:px-1.5 tw:text-micro tw:font-semibold tw:text-secondary tw:tabular-nums"
